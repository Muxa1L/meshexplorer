...
export default function WardrivePage() {
  ...
  return (
    <div
      className="flex flex-col md:flex-row bg-gray-50 text-gray-900 overflow-hidden"
    ...
    >
      ...
      <div
        className={`order-2 md:order-1 flex flex-col bg-white border-t md:border-t-0 md:border-r border-gray-200 md:w-80 md:flex-shrink-0 overflow-hidden md:max-h-none ${mobilePanelOpen ? "max-h-[60vh]" : "max-h-[3.25rem]"}`}
      >
        {/* Mobile compact bar – always visible, hidden on desktop */}
        <div className="md:hidden flex items-center justify-between px-4 h-[3.25rem] flex-shrink-0 border-b border-gray-100">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="p-1 text-gray-500 text-base leading-none"
        ...
        <div className="overflow-y-auto flex-1">
          ...
          <div className="p-4 border-b border-gray-200">
            <h1 className="text-lg font-bold text-gray-900 hidden md:block">📡 MeshCore Wardrive</h1>
